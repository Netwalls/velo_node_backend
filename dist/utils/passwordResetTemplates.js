 ...
 */
function passwordResetRequestTemplate(email, resetToken) {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
 ...
 * @returns HTML email template
 */
function passwordChangedTemplate(email) {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
 ...
 */
function passwordResetRequestText(email, resetToken) {
 ...
 * @returns Plain text email content
 */
function passwordChangedText(email) {
...
//# sourceMappingURL=passwordResetTemplates.js.map