...
exports.logoutNotificationTemplate = logoutNotificationTemplate;
const colors = {
    primary: '#2563eb',
    background: '#eaf1ff',
    card: '#fff',
...
function logoutNotificationTemplate(name) {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
//# sourceMappingURL=logoutNotificationTemplate.js.map