...
class TreasuryConfig {
    ...
    static getTreasuryWallet(chain, network) {
        ...
        if (!address) {
            throw new Error(`No treasury wallet configured for ${chain}/${network}. ` +
    ...
    static validateTreasuryAddress(address, chain) {
...
exports.TreasuryConfig = TreasuryConfig;
exports.default = TreasuryConfig;
