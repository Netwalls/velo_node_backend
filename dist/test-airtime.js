...
async function testAirtimeService() {
    ...
    try {
        ...
        const expectedAmount = await airtimeService_1.airtimeService.getExpectedCryptoAmount(1000, AirtimePurchase_1.Blockchain.BITCOIN);
        ...
        const purchaseResult = await airtimeService_1.airtimeService.processAirtimePurchase(userId, {
            type: "airtime",
            amount: 1000,
            chain: AirtimePurchase_1.Blockchain.BITCOIN,
            phoneNumber: "2349125381992",
            mobileNetwork: AirtimePurchase_1.MobileNetwork.AIRTEL,
            transactionHash: "69a72e1268d86f5e36ebdbbe05dd8212ce873227aeae7462a363d55abddbffad",
        });
