...
export class FeeController {
    ...
    static async calculateFee(req: Request, res: Response): Promise<void> {
        try {
            ...
            const calculation = FeeService.calculateFee(amountNum);
     ...
     */
    static async calculateBatchFees(req: Request, res: Response): Promise<void> {
        try {
            ...
            const summary = FeeService.calculateBatchSummary(numericAmounts);
     ...
     */
    static async getFeeConfig(req: Request, res: Response): Promise<void> {
        try {
            const config = FeeService.getFeeConfig();
            const tiers = FeeService.getFeeTiers();
            const minimumAmount = FeeService.getMinimumTransactionAmount();
     ...
     */
    static async getFeeHistory(req: AuthRequest, res: Response): Promise<void> {
        try {
     ...
     */
    static async getFeeStats(req: Request, res: Response): Promise<void> {
        try {
            const feeRepo = AppDataSource.getRepository(Fee);
